...
var entryAnalyzer = require('./entryAnalyzer.js').entryAnalyzer;
  ...
  var analyze = function(){
    ...
    return {
      ...
      label : name,
	    ...
	    badRequest : entry.badRequest,

	    fullLoadTime : entry.fullLoadTime,
      timeOnLoad : onLoad,
      timeOnContentLoad : onContentLoad,
	    timeToFirstByte : entry.timeToFirstByte,
	    dnsTime : entry.dnsTime ,
	    transferTime : entry.transferTime,
	    sendTime : entry.sendTime,
	    serverTime : entry.serverTime,
	    AvgConnectTime : entry.AvgConnectTime,
	    AvgBlockingTime : entry.AvgBlockingTime,

	    responseSize : entry.responseSize,
	    totalTextSize : entry.totalTextSize,
	    totalFontSize : entry.totalFontSize,
	    totalMediaSize : entry.totalMediaSize
//      ,rawEntry : entries
    };
  };
  return analyze();
